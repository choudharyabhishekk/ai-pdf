  ...
  return (
    <>
      ...
      <main className="max-w-6xl mx-auto p-8 pt-32">
        ...
        <section
          id="hero"
          className="flex flex-col items-center space-y-4  mb-7"
        >
        ...
        <section id="cta" className="py-10">
          <div className="max-w-7xl mx-auto bg-gradient-to-bl from-indigo-500 to-blue-500 rounded-2xl ">
            <div className="rounded-2xl p-12 lg:py-20  text-center bg-white/20 backdrop-blur-md text-white ring-1 ">
